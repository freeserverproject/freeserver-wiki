...
* 延伸や、駅の移転、経路の変更などで、**申請した計画に変更があった場合、タイミングに関わらず、直ちに申請内容の変更を申し出るか、再度申請をしなおして下さい。**<br>なお、「施工規格の詳細」の項目は、運営陣との打ち合わせが必要になる為、この限りではありません。
...
* コマンドブロック等を利用することで何らかの利益が見込める場合は、これの利用を認め、運営が設置することが可能です。(サーバーの負荷軽減や、利用するプレイヤーの利便性向上等)。
