...
* 駅や軌道を置く場所の近くに、他のプレイヤーが保護された土地が近接する場合、そのプレイヤーから承諾をもらう必要があります。
  ...
  * 以下の項目に全て当てはまる場合は、土地の保護所有者からの承諾は必要ありません。ただし、その旨を申請時に記載してください。サーバーへの最終ログイン日の確認は、[サーバーの詳細情報] (https://plan.freeserver.pro/)から可能です。
    * サーバーへの最終ログインが1ヶ月以上前である
    * Discordでの問い合わせ後、1週間以上返信や応答がない

対象の保護された土地の所有者が、1ヶ月以上ログインしていない場合、Discord等での問い合わせを行なったのちにその旨を申請フォームに記載することにより、
