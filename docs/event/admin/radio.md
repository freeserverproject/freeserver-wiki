...
運営ラジオとは、運営が主催し、[ガンマ](https://wiki.freeserver.pro/admins/ganma_.html)がメインパーソナリティを務め、ゲストを招いて配信するYouTubeライブ配信。5の倍数の回には今までの回の振り返りの回となります。

なお、FREESERVER公式Discordのステージでも聴取できます。
